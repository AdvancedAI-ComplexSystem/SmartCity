...
def parse_args():
    ...
    parser.add_argument("-mod",        type=str,           default="HyperbolicLight")
    ...
    parser.add_argument("-newyork_28_7",       action="store_true", default=False)
    parser.add_argument("-yongji",       action="store_true", default=False)
