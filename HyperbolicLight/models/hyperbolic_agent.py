...
class HNN_MLP(nn.Module):
    ...
    def __init__(self, c, manifold,len_feature):
        ...
        self.H_layer1 = HNNLayer(self.manifold,len_feature,64,self.c,0,'relu',1)
        self.H_layer2 = HNNLayer(self.manifold,64,32,self.c,0,'relu',1)
    def forward(self,x):
